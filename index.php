...
<head>
  ...
  <title>SkillBridge — Connect With Trusted Local Talent</title>
...
<body class="bg-base-200 min-h-screen flex flex-col">
  ...
  <nav class="navbar bg-base-100 shadow sticky top-0 z-50">
    <div class="flex-1">
      <a href="index.php" class="btn btn-ghost normal-case text-xl font-bold">SkillBridge</a>
    </div>
  ...
  <section class="hero min-h-[85vh] bg-base-100">
    <div class="hero-content flex-col lg:flex-row-reverse">
      <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=500&h=350&fit=crop" class="rounded-lg shadow-2xl" alt="SkillBridge workers">
      <div>
        <h1 class="text-5xl font-bold">Bridge the Gap Between Skill and Opportunity</h1>
        <p class="py-6 text-lg text-gray-600">
          SkillBridge connects individuals and businesses with verified skilled and unskilled laborers.
  ...
  <section class="py-16 bg-base-200">
    <div class="max-w-6xl mx-auto text-center">
      <h2 class="text-3xl font-bold mb-8">Why Choose SkillBridge?</h2>
  ...
  <section class="bg-primary text-primary-content py-16 text-center">
    ...
    <p class="mb-8">Join SkillBridge today and connect with trusted people in your area.</p>
    <div class="space-x-4">
  ...
  <footer class="footer p-10 bg-base-300 text-base-content mt-auto">
    <aside>
      <h3 class="text-xl font-bold">SkillBridge</h3>
      <p>Empowering trusted local connections.<br>© <?=date('Y')?> SkillBridge</p>
    </aside>
    <nav>
